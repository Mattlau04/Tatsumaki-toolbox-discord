    ...
    while True:
        ...
        for _ in range(loopfishing):
            ...
            for count in reversed(range(1, isleeplol+1)):
                ...
                print("Total trash items catched: " + str(totaltrashcatched) + " [" + str(percentage(totaltrashcatched, totalstuffcatched))[:5] + "%]")
                print("Total rare fish catched: " + str(totalrarecatched) + " [" + str(percentage(totalrarecatched, totalstuffcatched))[:5] + "%]")
                print('')
